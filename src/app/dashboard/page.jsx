...
const sidebarItems = [
    { key: "about", label: "আমাদের সম্পর্কে", icon: Home },
            ...
            <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900 transition-colors">
                ...
                <aside className="w-72 bg-white dark:bg-gray-800 shadow-lg hidden md:flex flex-col">
                    <div className="px-6 py-6 flex items-center gap-3 border-b dark:border-gray-700">
                        ...
                        <div>
                            <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100">মা-মনি একাডেমি</h3>
                        ...
                        {sidebarItems.map((it) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-2 rounded-lg mb-1 text-sm text-left transition-all ${isActive
